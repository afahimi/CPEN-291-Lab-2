...
class Rational:
    ...
    def add(self, secondRational):
        """adds 'this' rational to secondRational
               ...
               """
        new_denominator = self.denominator * secondRational.denominator
        new_numerator = self.numerator * secondRational.denominator + secondRational.numerator * self.denominator
    ...
    def multiply(self, secondRational):
        ...
        """
        new_denominator = self.denominator * secondRational.denominator
        new_numerator = self.numerator * secondRational.numerator
        print(f"{new_numerator}/{new_denominator}")
        return Rational(new_numerator, new_denominator)
        # to implement
    ...
    def divide(self, secondRational):
        """divides 'this' rational by secondRational
           returns the result as a rational number (type Rational)
        """
        new_denominator = self.denominator * secondRational.numerator
        new_numerator = self.numerator * secondRational.denominator
        print(f"{new_numerator}/{new_denominator}")
        return Rational(new_numerator, new_denominator)
        # to implement
    ...
    def toString(self):
        ...
        """
        if type(self.numerator) == int and type(self.denominator) == int:
